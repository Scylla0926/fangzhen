package com.geovis.receiver.readData.thermocline.ycwoa18;
 ...
 */
@Component
public class DecodeYcWoa18NcFile {
     ...
     * @return
     */
    public List<YcWoa18Vo> decode(String filePath, String outPath, String regex) {
        List<YcWoa18Vo> split = split(filePath, outPath, regex);
        return split;
    }
     ...
     * @return
     */
    private List<YcWoa18Vo> split(String filePath, String outPath, String regex) {

        // 返回入库信息信息
        List<YcWoa18Vo> result = new ArrayList<YcWoa18Vo>();
        // 文件信息类
...
//            //如果是Variable 那么就要判断是否为该要素中具有那些子要素 判断子要素数量是否大于2 如果大于2 再继续进行解析
            ...
            element = elName;
            {
                ...
                for (int i = 0, count = ps.length; i < count; i++) {
                    ...
                    // 准备入库信息
                    YcWoa18Vo woa18Vo = new YcWoa18Vo();
                    woa18Vo.setId(id);
