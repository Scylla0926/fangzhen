 ...
 * @category
 */
public class WriteFileJobGFbc implements Runnable {
...
//	private double[] interval;
    ...
    public WriteFileJobGFbc(Map<String, Object> datasMap, double[] ps, String prefixFileName, String elName, String element, String layerName, String outPath, int i, CopyOnWriteArrayList<String> outPathes, GribToPngUtils png, NcBeanPg pg, CountDownLatch latch) {
