package com.geovis.receiver.readData.inw.gjdNwp;
 ...
 */
@Component
public class DecodeGjdNWPNCFile {
    ...
    public static void main(String[] args) {
        String filePath = "C:\\Users\\Administrator\\Desktop\\nc\\TEMP2023081100-000.nc";
        String outPath = "C:/Users/Administrator/Desktop/nc/";
        List<GjdNwpVo> data = new DecodeGjdNWPNCFile().decode(filePath, outPath, "\\\\d{4}\\\\d{2}\\\\d{2}.(\\\\w+)$");
     ...
     * @return
     */
    public List<GjdNwpVo> decode(String filePath, String outPath, String regex) {
        List<GjdNwpVo> split = split(filePath, outPath, regex);
        return split;
    }
     ...
     * @return
     */
    private List<GjdNwpVo> split(String filePath, String outPath, String regex) {

        // 返回入库信息信息
        List<GjdNwpVo> result = new ArrayList<GjdNwpVo>();
        // 文件信息类
...
//            //如果是Variable 那么就要判断是否为该要素中具有那些子要素 判断子要素数量是否大于2 如果大于2 再继续进行解析
...

            {
                ...
                for (int i = 0, count = ps.length; i < count; i++) {
                    ...
                    // 准备入库信息
                    GjdNwpVo gjdNwpVo = new GjdNwpVo();
                    // 要素名称
