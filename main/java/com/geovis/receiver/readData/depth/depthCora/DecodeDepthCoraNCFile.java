package com.geovis.receiver.readData.depth.depthCora;
 ...
 */
@Component
public class DecodeDepthCoraNCFile {
    ...
    public static void main(String[] args) {
        String filePath = "C:/Users/Administrator/Desktop/nc/CORA_20190101_MLD.nc";
        String outPath = "C:\\Users\\Administrator\\Desktop\\nc";
        List<DepthCoraVo> data = new DecodeDepthCoraNCFile().decode(filePath, outPath, "\\\\d{4}\\\\d{2}\\\\d{2}.(\\\\w+)$");
     ...
     * @return
     */
    public List<DepthCoraVo> decode(String filePath, String outPath, String regex) {
        List<DepthCoraVo> split = split(filePath, outPath, regex);
        return split;
    }
     ...
     * @return
     */
    private List<DepthCoraVo> split(String filePath, String outPath, String regex) {

        // 返回入库信息信息
        List<DepthCoraVo> result = new ArrayList<DepthCoraVo>();
        // 文件信息类
...
//            //如果是Variable 那么就要判断是否为该要素中具有那些子要素 判断子要素数量是否大于2 如果大于2 再继续进行解析
...

            {
                ...
                for (int i = 0, count = ps.length; i < count; i++) {
                    ...
                    // 准备入库信息
                    DepthCoraVo seaCurrentNwpVo = new DepthCoraVo();
                    // 要素名称
