package com.geovis.receiver.readData.depth.depthNwp;

import com.alibaba.fastjson.JSONObject;
import com.geovis.receiver.pojo.model.NcBeanPg;
import com.geovis.receiver.pojo.vo.DepthNwpVo;
import com.geovis.receiver.readData.current.currentNwp.WriteFileJobUV;
 ...
 */
@Component
public class DecodeDepthNwpNCFile {
    ...
    public static void main(String[] args) {
        String filePath = "C:/Users/Administrator/Desktop/nc/NWP_2022080312-000_MLD.nc";
        String outPath = "C:\\Users\\Administrator\\Desktop\\nc";
        List<DepthNwpVo> data = new DecodeDepthNwpNCFile().decode(filePath, outPath, "\\\\d{4}\\\\d{2}\\\\d{2}.(\\\\w+)$");
     ...
     * @return
     */
    public List<DepthNwpVo> decode(String filePath, String outPath, String regex) {
        List<DepthNwpVo> split = split(filePath, outPath, regex);
        return split;
    }
     ...
     * @return
     */
    private List<DepthNwpVo> split(String filePath, String outPath, String regex) {

        // 返回入库信息信息
        List<DepthNwpVo> result = new ArrayList<DepthNwpVo>();
        // 文件信息类
...
//            //如果是Variable 那么就要判断是否为该要素中具有那些子要素 判断子要素数量是否大于2 如果大于2 再继续进行解析
            ...
            if (elName.equals("v_zl") || elName.equals("lon") || elName.equals("lat")) {
                continue;
            }
...

            {
                ...
                for (int i = 0, count = ps.length; i < count; i++) {
                    ...
                    // 准备入库信息
                    DepthNwpVo seaCurrentNwpVo = new DepthNwpVo();
                    // 要素名称
...
//                        throw new RuntimeException(e);
                    ...
                    seaCurrentNwpVo.setForecastTime(fileDate.substring(8, 10));
                    seaCurrentNwpVo.setTimer(new FileUtil().getFileTimer(prefixFileName, regex));
                    seaCurrentNwpVo.setSrcFileType(suffix);
                    seaCurrentNwpVo.setInsertTime(new Date());
                    seaCurrentNwpVo.setRegionType("GLB");
