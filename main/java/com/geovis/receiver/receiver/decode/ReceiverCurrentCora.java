...
@Slf4j
@Scope("prototype")
public class ReceiverCurrentCora extends ReceiverBase {
    private String msg = "";
    ...
    @Resource
    CoraCurrentServiceImpl seaCurrentDao;
    ...
    public boolean produce(Produce pro) {
        ...
        List<CurrentCoraVo> decode = null;
        try {
    ...
    public boolean dataStore(Produce pro) {
        try {
            ...
            List<CurrentCoraVo> seacrVoList = (List<CurrentCoraVo>) objectList.get(0);

            if (seacrVoList != null ) {
                /////----1.赋值存库
                for (CurrentCoraVo seaCurrentVo : seacrVoList) {
