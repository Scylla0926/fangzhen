...
import com.geovis.receiver.service.impl.Woa18ServiceImpl;
...
@Slf4j
@Scope("prototype")
public class ReceiverWoa18 extends ReceiverBase {
    private String msg = "";
    ...
    public boolean dataStore(Produce pro) {
        try {
            ...
            Map<String, Object> structure = ReadGribDataUtil.getStructure(pro.getSrcFilePath());
            Map<String, String> globalAttributes = ReadGribDataUtil.getGlobalAttributes(pro.getSrcFilePath());
            String date_created = globalAttributes.get("date_created");
            String[] split = date_created.split("-");
            for (NwpPngCurrencyBean bean : fbcVos) {
                Woa18Vo vo = new Woa18Vo();
