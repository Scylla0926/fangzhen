...
import com.geovis.receiver.dao.SubSurfaceBuoyDao;
...
import com.geovis.receiver.readData.subBuoy.DecodeBuoyNCFile;
...
@Slf4j
@Scope("prototype")
public class ReceiverSubsfBuoy extends ReceiverBase {
    private String msg = "";
    ...
    @Autowired
    DecodeBuoyNCFile decodeBuoyNCFile;

    @Resource
    SubSurfaceBuoyDao subSurfaceBuoyDao;
    ...
    public boolean produce(Produce pro) {
        ...
        List<SubSurfaceBuoyVo> decode = null;
        try {
    ...
    public boolean dataStore(Produce pro) {
        try {
            ...
            List<SubSurfaceBuoyVo> beans = (List<SubSurfaceBuoyVo>) objectList.get(0);
            for (SubSurfaceBuoyVo bean : beans) {
                subSurfaceBuoyDao.insert(bean);
            }
            return true;
        } catch (Exception e) {
            e.printStackTrace();
