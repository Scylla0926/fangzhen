...
@Slf4j
@Scope("prototype")
public class ReceiverCurrentNwp extends ReceiverBase {
    private String msg = "";
    ...
    @Autowired
    DecodeCurrentNwpNCFile decodeCurrentNwpNCFile;
    ...
    public boolean produce(Produce pro) {
        ...
        try {
            ...
            decode = decodeCurrentNwpNCFile.decode(srcFile.getAbsolutePath(), outFilePath, regex);
        } catch (Exception e) {
