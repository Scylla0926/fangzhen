...
import com.geovis.receiver.service.impl.ModasServiceImpl;
...
@Slf4j
@Scope("prototype")
public class ReceiverModas extends ReceiverBase {
    private String msg = "";
...
//                vo.setMin(level.substring(10, 12));
                ...
                vo.setDate(sdf.parse(fbcVos.get(0).getFileName().split("_")[3].substring(0, 8)));
                ...
                String region = fileUtil.getFileRegion(srcFile.getName(), configElement.getRegexList().get(0));
                if (region.equals("ind")) {
                    vo.setRegionType("IO");
                } else if (region.equals("scs")) {
                    vo.setRegionType("SCS");
                } else if (region.equals("nwp")) {
                    vo.setRegionType("NWP");
                }

                modasDao.saveOrUpdateObj(vo);
            }
        } catch (Exception e) {
            e.printStackTrace();
